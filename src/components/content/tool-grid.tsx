                ...
                return (
                    <li key={slug}>
                        <Reveal delay={(i % 3) * 0.06} className="h-full">
                                <Link
                                    to={`/${slug}`}
                                    className="group flex h-full flex-col gap-3 rounded-2xl border border-brand-100 bg-primary p-5 shadow-xs transition-[translate,box-shadow,border-color] duration-200 ease-out outline-focus-ring hover:border-brand hover:shadow-lg focus-visible:outline-2 focus-visible:outline-offset-2 motion-safe:hover:-translate-y-[3px]"
                                >
