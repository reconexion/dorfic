                            ...
                            return (
                                <li key={slug}>
                                    ...
                                    >
                                        ...
                                        {cards[slug].name}
                                        <ArrowRight aria-hidden className="ml-auto size-4 text-fg-brand-primary opacity-0 transition duration-150 group-hover:translate-x-0.5 group-hover:opacity-100" />
                                    </Link>
                                </li>
                            );
                        })}
