...
export const styles = sortCx({
    common: {
        root: [
            "group relative inline-flex h-max cursor-pointer items-center justify-center whitespace-nowrap outline-brand transition duration-150 ease-out before:absolute focus-visible:outline-2 focus-visible:outline-offset-2 motion-safe:active:scale-[0.97]",
    ...
    colors: {
        primary: {
            root: [
                "btn-shine bg-brand-solid text-white shadow-[0_8px_20px_-8px_rgb(255_106_0/0.7)] ring-1 ring-transparent ring-inset hover:bg-brand-solid_hover hover:shadow-[0_12px_28px_-8px_rgb(255_106_0/0.8)] data-loading:bg-brand-solid_hover motion-safe:hover:-translate-y-px motion-safe:active:translate-y-0 motion-safe:active:scale-[0.97]",
        ...
        secondary: {
            root: [
                "bg-brand-50 text-brand-secondary shadow-xs ring-1 ring-brand-300 ring-inset hover:bg-brand-100 hover:text-brand-secondary_hover hover:ring-brand-400 data-loading:bg-brand-100",
                // Icon styles
                "*:data-icon:text-fg-brand-primary",
            ].join(" "),
        },
        tertiary: {
            root: [
                "text-brand-secondary hover:bg-brand-50 hover:text-brand-secondary_hover data-loading:bg-brand-50",
                // Icon styles
                "*:data-icon:text-fg-brand-primary",
            ].join(" "),
        },
